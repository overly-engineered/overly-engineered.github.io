...
var BoardList = React.createClass({
  ...
  render: function() {
    ...
    if(!this.props.loggedIn){
      loginSignIn = <div><SignUpButton onNewUser={this.props.onNewUser} SignUpError={this.props.SignUpError}/><LogInButton onLogin={this.props.onLogin} LogInError={this.props.LogInError}/></div>;
    }else{
      loginSignIn = <div>
